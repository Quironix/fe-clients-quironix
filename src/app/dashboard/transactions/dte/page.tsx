        ...
        <div className="flex justify-between items-start gap-5 p-3 border border-gray-200 rounded-md h-[320px]">
          ...
          <div className="w-[37.5%] h-full">
            <CreateManual
              title={
                <>
                  Subir <span className="text-orange-500">un DTE</span> por
                  carga <span className="text-orange-500">manual</span>
                </>
              }
              ...
              buttonText="Carga manual"
              buttonLink="/dashboard/debtors/create"
            />
          </div>
          <div className="w-[37.5%] h-full">
            <BulkData
