...
import { ColumnConfig } from "./types/sheet-types";
...
interface ColumnSectionProps<TData, TValue> {
...
export function ColumnSection<TData, TValue>({
  columns,
  columnVisibility,
  onColumnVisibilityChange,
  columnOrder,
  onColumnOrderChange,
}: ColumnSectionProps<TData, TValue>) {
  ...
  const [columnConfigs, setColumnConfigs] = useState<ColumnConfig[]>(getColumnConfigs());
