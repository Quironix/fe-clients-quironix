...
export const KPIAIChat = () => {
  ...
  return (
    <Card className="border-2 border-blue-100 shadow-sm h-[500px] flex flex-col">
      <CardHeader className="pb-3 bg-gradient-to-r from-orange-50 to-white border-b border-gray-200">
        <CardTitle className="text-base font-bold text-gray-900 flex items-center gap-2">
          <SparklesIcon className="h-5 w-5 text-orange-500" />
          Asistente de IA
        </CardTitle>
        <p className="text-xs text-gray-600 mt-1">
          Pregúntame sobre tus KPIs
        </p>
      </CardHeader>
