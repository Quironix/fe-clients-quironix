  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-start justify-start w-full space-y-2">
        ...
        <div className="flex flex-col items-start w-full">
          ...
          {litigationNumber && (
            <div className="flex items-start gap-1 mt-1">
              <span className="font-bold text-xs">Monto litigio:</span>
        ...
        {/* Input de monto en litigio - condicional */}
        {onAmountChange && showAmountInput && (
          <div className="flex flex-col gap-1 w-full pt-2 border-t border-orange-300">
            <label
              className={`text-xs font-semibold ${isSelected ? "text-orange-700" : "text-gray-500"}`}
            >
              Monto en litigio *
            </label>
            <Input
